 ...
 *
 */
@WebServiceClient(name = "CustomerPortService", targetNamespace = "http://www.crmpoc.com/customer", wsdlLocation = "http://api-gateway:9060/customer-service/ws/customers.wsdl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERPORTSERVICE_QNAME = new QName("http://www.crmpoc.com/customer", "CustomerPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = com.crmpoc.catalog.CatalogPortService.class.getResource("/static/customers.wsdl");
            if (url == null) throw new MalformedURLException("static/customers.wsdl does not exist in the module.");
    ...
    public CustomerPort getCustomerPortSoap11() {
        return super.getPort(new QName("http://www.crmpoc.com/customer", "CustomerPortSoap11"), CustomerPort.class);
    }
    ...
    public CustomerPort getCustomerPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.crmpoc.com/customer", "CustomerPortSoap11"), CustomerPort.class, features);
    }
